...
import PanelMenu from '../../components/panel-menu/panel-menu.component';
            ...
            <div style={{ width: '100%', height: '100%' }}>
                <header>
                    <ul className="header-menu">
                        <li className="header-menu-item">Strona głowna</li>
                        <li className="header-menu-item">O nas</li>
                        <li className="header-menu-item">Menu</li>
                        <li className="header-menu-item">Kontakt</li>
                        <li className="header-menu-item">Logowanie</li>
                    </ul>
                    <span
                        className="header-menu-button"
                        onClick={() => {
                            this.panelRef.current.style.display = 'flex';
                        }}
                    >
                        <FontAwesomeIcon icon={faBars} />
                    </span>
                </header>
                <PanelMenu reference={this.panelRef} />
