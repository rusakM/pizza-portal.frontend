      ...
      <div>
        <section className="home">
          <div className="home-container">
            ...
            <div className="slogan-container">
              ...
              <h2 className="slogan-description">NAJLEPSZA PIZZA W MIEŚCIE!</h2>
            </div>
        ...
        <section className="about" id="about">
          ...
          <div className="about-right">
            ...
            <p className="about-description">
              Sieć Pizza Portal funkcjonuje na rynku od końca lat 90. W
              międzyczasie wielokrotnie była nagradzana przez Konsumentów, za
              pyszne jedzenie, atmosferę, świetną obsługę. Przez lata skupiliśmy
              się na sprzedaży pizzy przez internet, abyś mógł wygodnie zamówić
              pizzę z wyprzedzeniem i przyjść do nas odbierając już gotowe
              zamówienie.
            </p>
            <p className="about-description">
              Naszą misją jest dostarczanie najlepszego jedzenia – tak, jak
              lubisz, tam, gdzie chcesz i wtedy, kiedy chcesz. W tym celu
              rozwijamy nasze kompetencje i możliwości tak, aby móc serwować
              najlepsze jedzenie i dostarczać je wszędzie tam, gdzie nasi
              przyjaciele go potrzebują.
            </p>
          </div>
        </section>
        ...
        <aside className="form-popup" ref={this.popupRef}>
          <div className="form-popup-container">
            <p className="form-popup-message">Wiadomość została wysłana</p>
            <span
